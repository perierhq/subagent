...
Never rate a model off a single benchmark number, and never copy a leaderboard rank into our table. A rating (re)evaluation has three mandatory inputs:
